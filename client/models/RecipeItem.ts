...
import { RecipeItemPivot } from './RecipeItemPivot';
...
export class RecipeItem {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "pivot",
            "baseName": "pivot",
            "type": "RecipeItemPivot",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return RecipeItem.attributeTypeMap;
    }
...
export type RecipeItemArticleEnum = "a" | "the" ;
