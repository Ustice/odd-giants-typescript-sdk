...
export class RecipeItemsOutputInner {
    'id': string;
    'categoryId': string;
    'label': string;
    'nameSingle': string;
    'namePlural': string;
    'article': RecipeItemsOutputInnerArticleEnum;
    'description': string;
    'hasInfo': number;
    'hasInfopage': number;
    'isRoutable': number;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "article",
            "baseName": "article",
            "type": "RecipeItemsOutputInnerArticleEnum",
            "format": ""
        },
        {
            "name": "description",
    ...
    static getAttributeTypeMap() {
        return RecipeItemsOutputInner.attributeTypeMap;
    }
...
export type RecipeItemsOutputInnerArticleEnum = "a" | "the" ;
