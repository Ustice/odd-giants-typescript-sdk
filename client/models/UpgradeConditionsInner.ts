...
export class UpgradeConditionsInner {
    'type': UpgradeConditionsInnerTypeEnum;
    'level'?: number;
    ...
    static getAttributeTypeMap() {
        return UpgradeConditionsInner.attributeTypeMap;
    }
...
export type UpgradeConditionsInnerTypeEnum = "7" ;
